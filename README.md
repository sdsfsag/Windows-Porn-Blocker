...
## How does it work?
- It adds each site + IP address to the hosts file and adds rules to the firewall, which requires administrator rights, so don't be surprised if the UAC screen pops up. This may cause Windows Defender or your antivirus program to say that Porn Blocker is a virus
